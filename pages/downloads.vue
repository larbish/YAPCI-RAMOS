<template>
    <div class="h-screen w-full overflow-x-clip bg-white relative text-black">
        <div class="wrapper flex h-full flex-nowrap bg-white">
            <section v-for="(section, index) in sections" :key="index"
                ...
                <div class="flex flex-col">
                    ...
                    <div class=" min-w-96 lg:min-w-fit mt-0.5">
                        <div v-for="(item, idx) in section.items" :key="idx" class="grid grid-cols-3 uppercase gap-x-4">
        ...
        <div
            ...
            <p v-for="link in navLinks" :key="link">{{ link }}</p>
        </div>
