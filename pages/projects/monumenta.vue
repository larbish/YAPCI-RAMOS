<template>
    ...
    <div class="lg:hidden bg-white min-h-[100dvh] h-[100dvh] overflow-y-auto relative">
        ...
        <section @click="activateSecondSection"
            class="w-full h-[60dvh] bg-white bg-opacity-90 fixed bottom-0 pt-7 border-t-[0.8px] border-black transition-all duration-700 backdrop-blur-3xl"
        ...
        <section @click="activateThirdSection"
            class="w-full h-[calc(60dvh-30px)] bg-white bg-opacity-90 pt-7 fixed bottom-0 border-t-[0.8px] border-black transition-all duration-700 backdrop-blur-3xl"
