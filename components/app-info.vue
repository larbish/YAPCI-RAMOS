                ...
                <section class="w-full lg:grid lg:grid-cols-9 gap-x-5 font-normal mt-10">
                    <article class="lg:col-span-3">
                        ...
                        <p class="tracking-wider mt-1 lg:mt-0">
                            ...
                            challenge the border of comfort between the body and society while engaging the intricate
                    ...
                    <article class="lg:col-span-6 mt-6 lg:mt-0">
                        ...
                        <p class="tracking-wider mt-1 lg:mt-0">
                            ...
                            Contemporary, Delaware; Catinca Tabacaru Gallery, Nueva York; TEA Tenerife Espacio de las
                            Artes, Tenerife; CAAM Centro Atlántico de Arte Moderno, Las Palmas de Gran Canaria; Mario
                            ...
                            Tegucigalpa; Rencontres Africaines de la Photographie, Bamako; Triennal de Angola, Luanda y
