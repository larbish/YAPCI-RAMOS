<template>
    <div class="w-full bg-white text-black">
        ...
        <div class="p-2 flex gap-x-2 leading-[1.3]">
            ...
            <div class="flex flex-col ml-auto w-[63.2%] min-w-[63.2%] max-w-[63.2%]">
                <p class="font-normal">In 'Monumenta. Nine Guanche Incarnations', I aim to give visibility to the
                ...
                <p class=" mt-3 font-normal"> Guanche women held active roles in the communities of pre-Hispanic
                    Tenerife.
        ...
        <div class="w-full flex-col flex mt-5">
            ...
            <div class="w-[50.1%]">
                <img src="@/assets/images/group-15.png" class="w-full" alt="">
            </div>
        </div>
        ...
        <div class="w-full flex-col flex mt-5">
            ...
            <img src="@/assets/images/image-eight.png" class="w-full" alt="">

            <img src="@/assets/images/image-ten.png" class="w-full" alt="">

            <img src="@/assets/images/image-nine.png" class="w-full" alt="">
