<template>
    <div class="w-full overflow-x-clip">
        <div ref="container" class="w-full h-full relative flex overflow-x-clip">
            <section @click="activeSection = 0" ref="sectionOne" class="w-full relative min-w-10 overflow-x-clip">
                <div class="min-w-[calc(100vw-40px)]">
                    <SectionOne></SectionOne>
                </div>
            </section>
            <section @click="activeSection = 1" ref="sectionTwo"
                class="border-l-gray-500 border-l h-full absolute left-[calc(100%-80px)] min-w-[calc(100%-80px)] bg-white bg-opacity-95  backdrop-blur-2xl z-10">
            ...
            <section @click="activeSection = 2" ref="sectionThree"
                class="border-l-gray-500 border-l h-full absolute left-[calc(100%-40px)] min-w-[calc(100%-80px)] bg-white-500 backdrop-blur-2xl z-10">
