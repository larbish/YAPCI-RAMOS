...
<script setup>
import SectionOne from '@/components/parto/section-one.vue';
import SectionTwo from '~/components/parto/section-two.vue';
import SectionThree from '~/components/parto/section-three.vue';

import SectionOneMobile from '~/components/parto/section-one-mobile.vue';
